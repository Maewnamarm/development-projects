...
const AlluserLoginPage: React.FC = () => {
        ...
        <div className="p-8">
          <form onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-md bg-blue-800 px-4 py-3 text-white font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-60"
            >
